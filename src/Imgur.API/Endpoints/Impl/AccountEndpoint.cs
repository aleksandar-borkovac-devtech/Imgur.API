...
namespace Imgur.API.Endpoints.Impl
{
    ...
    public class AccountEndpoint : EndpointBase, IAccountEndpoint
    {
            ...
            GalleryFavoritesSortOrder? gallerySortOrder = GalleryFavoritesSortOrder.Newest)
        {
            ...
            var favorites = await MakeEndpointRequestAsync<IGalleryAlbumImageBase[]>(HttpMethod.Get, endpointUrl);
            return favorites;
        }
        ...
        public async Task<IGalleryAlbumImageBase[]> GetAccountSubmissionsAsync(string username = "me", int? page = null)
        {
            ...
            var submissions = await MakeEndpointRequestAsync<IGalleryAlbumImageBase[]>(HttpMethod.Get, endpointUrl);
            return submissions;
        }
            ...
            bool? newsletterSubscribed = null)
        {
            ...
            var result = await MakeEndpointRequestAsync<bool>(HttpMethod.Post, endpointUrl, content);
			return result;
        }
        ...
        public async Task<IAlbum[]> GetAlbumsAsync(string username = "me", int? page = null)
        {
            ...
            return await MakeEndpointRequestAsync<Album[]>(HttpMethod.Get, endpointUrl);
        }
        ...
        public async Task<string[]> GetAlbumIdsAsync(string username = "me", int? page = null)
        {
            ...
            return await MakeEndpointRequestAsync<string[]>(HttpMethod.Get, endpointUrl);
        }
            ...
            CommentSortOrder commentSortOrder = CommentSortOrder.Newest, int? page = null)
        {
            ...
            return await MakeEndpointRequestAsync<Comment[]>(HttpMethod.Get, endpointUrl);
        }
        ...
        public async Task<IImage[]> GetImagesAsync(int? page = null)
        {
            ...
            return await MakeEndpointRequestAsync<Image[]>(HttpMethod.Get, endpointUrl);
        }
